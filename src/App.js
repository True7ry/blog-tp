    ...
    <div className="App">
      ...
      <header className="App-header">
        <ul className='header-dad'>
          ...
          <img className='arg-icon' src={require('./img/arg-icon.png')} />
        </ul>
      </header>
      <div className='inicio'>
        <img  src={require('./img/bandera.png')} />
      </div>
      ...
      <div className='pag'>
        ...
        />
        <img src={require('./img/revistaMalvinas.jpg')} />
      </div>
      <div className='pag n2'>
        ...
        />
        <img src={require('./img/heridos.jpg')} className='img-h'/>
      </div>
        <div className='pag n2'>
        <Paginas
        titulo='Example text'
       ...
       /> 
       <img className='img-ej' src={require('./img/ejercito-m.jpg')} />
      </div>
      <footer>
        <h2>Creditos:</h2>
